...
export const fetchNotices = createAsyncThunk("notices/fetchAll",
 async ({keyword, category, species, locationId, radioSearch, page, sex}, thunkAPI) => {
  ...
  // ========================================================================================================================================================
  // ======================== WHEN CHOOSEN ANY 5 (FIVE) PARAMETERS ========================================================================
  else if (keyword && category && species && locationId && radioSearch && !sex) {
    if(radioSearch === "Cheap") {
        const response = await axios.get(`/notices?page=${page}&keyword=${keyword}&category=${category}&species=${species}&locationId=${locationId}&byPrice=true`);
        filteredData = response.data;
        return filteredData;
      } else if (radioSearch === "Expensive") {
        const response = await axios.get(`/notices?page=${page}&keyword=${keyword}&category=${category}&species=${species}&locationId=${locationId}&byPrice=false`);
        filteredData = response.data;
        return filteredData;
      } else if (radioSearch === "Popular") {
        const response = await axios.get(`/notices?page=${page}&keyword=${keyword}&category=${category}&species=${species}&locationId=${locationId}&byPopularity=false`);
        filteredData = response.data;
        return filteredData;
      } else  if (radioSearch === "Unpopular") {
        const response = await axios.get(`/notices?page=${page}&keyword=${keyword}&category=${category}&species=${species}&locationId=${locationId}&byPopularity=true`);
        filteredData = response.data;
        return filteredData;
    }
  } else if (keyword && category && species && locationId && !radioSearch && sex) {
    const response = await axios.get(`/notices?&limit=2000&keyword=${keyword}&category=${category}&species=${species}&locationId=${locationId}`);
    let filteredResults = response.data.results.filter(item => item.sex === sex);
    const totalPages = Math.ceil(filteredResults?.length / 6);
    const displayedObjects = filteredResults.slice(startIndex, endIndex);
    const sendData = {results: displayedObjects, totalPages: totalPages};
    ...
    let response;
    if(radioSearch === "Cheap") {
      response = await axios.get(`/notices?&limit=2000&keyword=${keyword}&category=${category}&species=${species}&byPrice=true`);
    } else if (radioSearch === "Expensive") {
      response = await axios.get(`/notices?&limit=2000&keyword=${keyword}&category=${category}&species=${species}&byPrice=false`);
    } else if (radioSearch === "Popular") {
      response = await axios.get(`/notices?&limit=2000&keyword=${keyword}&category=${category}&species=${species}&byPopularity=false`);
    } else  if (radioSearch === "Unpopular") {
      response = await axios.get(`/notices?&limit=2000&keyword=${keyword}&category=${category}&species=${species}&byPopularity=true`);
    }
    let filteredResults = response?.data?.results?.filter(item => item?.sex === sex);
    const totalPages = Math.ceil(filteredResults?.length / 6);
    const displayedObjects = filteredResults.slice(startIndex, endIndex);
    ...
    let response;
    if(radioSearch === "Cheap") {
      response = await axios.get(`/notices?&limit=2000&keyword=${keyword}&category=${category}&locationId=${locationId}&byPrice=true`);
    } else if (radioSearch === "Expensive") {
      response = await axios.get(`/notices?&limit=2000&keyword=${keyword}&category=${category}&locationId=${locationId}&byPrice=false`);
    } else if (radioSearch === "Popular") {
      response = await axios.get(`/notices?&limit=2000&keyword=${keyword}&category=${category}&locationId=${locationId}&byPopularity=false`);
    } else  if (radioSearch === "Unpopular") {
      response = await axios.get(`/notices?&limit=2000&keyword=${keyword}&category=${category}&locationId=${locationId}&byPopularity=true`);
    }
    let filteredResults = response?.data?.results?.filter(item => item?.sex === sex);
    const totalPages = Math.ceil(filteredResults?.length / 6);
    const displayedObjects = filteredResults.slice(startIndex, endIndex);
    ...
    let response;
    if(radioSearch === "Cheap") {
      response = await axios.get(`/notices?&limit=2000&keyword=${keyword}&species=${species}&locationId=${locationId}&byPrice=true`);
    } else if (radioSearch === "Expensive") {
      response = await axios.get(`/notices?&limit=2000&keyword=${keyword}&species=${species}&locationId=${locationId}&byPrice=false`);
    } else if (radioSearch === "Popular") {
      response = await axios.get(`/notices?&limit=2000&keyword=${keyword}&species=${species}&locationId=${locationId}&byPopularity=false`);
    } else  if (radioSearch === "Unpopular") {
      response = await axios.get(`/notices?&limit=2000&keyword=${keyword}&species=${species}&locationId=${locationId}&byPopularity=true`);
    }
    let filteredResults = response?.data?.results?.filter(item => item?.sex === sex);
    const totalPages = Math.ceil(filteredResults?.length / 6);
    const displayedObjects = filteredResults.slice(startIndex, endIndex);
    ...
    let response;
    if(radioSearch === "Cheap") {
      response = await axios.get(`/notices?&limit=2000&category=${category}&species=${species}&locationId=${locationId}&byPrice=true`);
    } else if (radioSearch === "Expensive") {
      response = await axios.get(`/notices?&limit=2000&category=${category}&species=${species}&locationId=${locationId}&byPrice=false`);
    } else if (radioSearch === "Popular") {
      response = await axios.get(`/notices?&limit=2000&category=${category}&species=${species}&locationId=${locationId}&byPopularity=false`);
    } else  if (radioSearch === "Unpopular") {
      response = await axios.get(`/notices?&limit=2000&category=${category}&species=${species}&locationId=${locationId}&byPopularity=true`);
    }
    let filteredResults = response?.data?.results?.filter(item => item?.sex === sex);
    const totalPages = Math.ceil(filteredResults?.length / 6);
    const displayedObjects = filteredResults.slice(startIndex, endIndex);
    ...
    let response;
    if(radioSearch === "Cheap") {
      response = await axios.get(`/notices?&limit=2000&keyword=${keyword}&category=${category}&species=${species}&locationId=${locationId}&byPrice=true`);
    } else if (radioSearch === "Expensive") {
      response = await axios.get(`/notices?&limit=2000&keyword=${keyword}&category=${category}&species=${species}&locationId=${locationId}&byPrice=false`);
    } else if (radioSearch === "Popular") {
      response = await axios.get(`/notices?&limit=2000&keyword=${keyword}&category=${category}&species=${species}&locationId=${locationId}&byPopularity=false`);
    } else  if (radioSearch === "Unpopular") {
      response = await axios.get(`/notices?&limit=2000&keyword=${keyword}&category=${category}&species=${species}&locationId=${locationId}&byPopularity=true`);
    }
    let filteredResults = response?.data?.results?.filter(item => item?.sex === sex);
    const totalPages = Math.ceil(filteredResults?.length / 6);
    const displayedObjects = filteredResults.slice(startIndex, endIndex);
